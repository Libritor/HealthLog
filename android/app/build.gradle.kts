...
android {
    namespace = "com.example.muse_headband_app"
    ...
    defaultConfig {
        ...
        applicationId = "com.example.muse_headband_app"
...
dependencies {
    // LibMuse SDK for connecting to Muse headbands
